// 桃園市行政區特徵數據 (基於Jenks Natural Breaks分類)
const districtData = {
    "中壢區": {
        "潛力等級": "高潛力",
        "集群編號": 0,
...
// 聚類統計 (基於Jenks Natural Breaks)
const clusterStats = {
    "高潛力": {
        "districts": ["中壢區", "桃園區", "龍潭區", "龜山區", "蘆竹區"],
        "avgScore": 0.638,
        "color": "#e74c3c",
        "jenks_threshold": "≥ 0.453"
    },
    "中潛力": {
        "districts": ["八德區", "大園區", "平鎮區", "復興區", "楊梅區"],
        "avgScore": 0.361,
        "color": "#f39c12",
        "jenks_threshold": "0.266 - 0.453"
    },
    "低潛力": {
        "districts": ["大溪區", "新屋區", "觀音區"],
        "avgScore": 0.186,
        "color": "#3498db",
        "jenks_threshold": "< 0.266"
    }
};
...
// Jenks Natural Breaks 分類信息
const jenksInfo = {
    "method": "Jenks Natural Breaks",
    "breaks": [0.117, 0.266, 0.453, 0.774],
    "features": {
